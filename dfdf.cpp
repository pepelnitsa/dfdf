...
int main() {
    ...
    Font font(14, "Arial", true, false, false, "Blue");
    SolidBrush brush("Red");
    Button button(100, 50, 14, "Click me!", "White");

    cout << "Drawing a rectangle on the canvas." << endl;
    cout << "Setting font size to: " << font.size << endl;
    cout << "Applying red solid brush." << endl;
